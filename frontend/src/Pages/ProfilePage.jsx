...
const ProfilePage = () => {
  ...
  const [Course, setCourse] = useState(userStore?.Course || "");
  const [Year, setYear] = useState(userStore?.Year || "");
  
  const [Specialization, setSpecialization] = useState(userStore?.Specialization || "");
